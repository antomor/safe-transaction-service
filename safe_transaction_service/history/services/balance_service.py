...
class BalanceService:
    ...
    def get_usd_balances(self, safe_address: ChecksumAddress, only_trusted: bool = False,
        ...
        try:
            ...
            logger.info(f'eth_usd_price {eth_price}')
        ...
        for balance, token_eth_value_with_timestamp in zip(balances, token_eth_values_with_timestamp):
            logger.info(f'balance, token_eth_value_with_timestamp: {balance}, {token_eth_value_with_timestamp}')
            ...
            if not token_address:  # Ether
                ...
                logger.info(f'fiat_balance, fiat_conversion: {fiat_balance}, {fiat_conversion}')
