...
class RSKPriceProvider(PriceOracle, UsdPricePoolOracle):
    ...
    def __init__(self, ethereum_network):
    ...
    def _is_rif_or_trif(self, token_address):
        return (self.ethereum_network == EthereumNetwork.RSK_TESTNET and token_address == self.TRIF_ADDRESS) \
            or (self.ethereum_network == EthereumNetwork.RSK_MAINNET and token_address == self.RIF_ADDRESS)
